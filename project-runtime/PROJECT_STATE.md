...
SEMANTIC_REASON: WB provider migration checkpoint committed and pushed; route to Ozon provider migration.
```
...
BLOCKS: NONE
BLOCKED_BY: NONE
RESOLUTION_PATH: implement Ozon provider migration after WB checkpoint
```
